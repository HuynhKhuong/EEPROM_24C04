...
constexpr uint16_t blockMessageDLC{262U}; // Data + Address = 255+3 +mode(1) +ID(1) +DLC(1) +endofFrame(1)
...
struct BlockMessageLayout : MessageHandlerInterface {
public:
...
struct ByteMessageLayout : MessageHandlerInterface {
public:
